    ...
    <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      <div className="mb-2">
        ...
        <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
          You’ll be able to create workspaces and manage tasks right away.
        </p>
      </div>
      ...
      <div className="mt-4 text-sm text-zinc-600 dark:text-zinc-300">
        ...
        <a className="font-medium text-zinc-950 underline underline-offset-4 dark:text-zinc-50" href="/auth/sign-in">
          Sign in
        </a>
      </div>
    </div>
